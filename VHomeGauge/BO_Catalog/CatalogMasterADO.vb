...
Public MustInherit Class CatalogMasterADO
    ...
    Private Function RuleCheck() As Boolean
        ...
        If IsNothing(Name) OrElse IsNothing(FK_Parent) OrElse IsNothing(FK_Child) Then
            sMessage &= vbCrLf
        ...
        If Name IsNot Nothing AndAlso Name = "" OrElse String.IsNullOrEmpty(Name) Then
            sMessage &= vbCrLf
            sMessage &= "XValue can't be empty or Null."
            bRule_3_Met = False
            '
        End If
        '
        ' Rule 4 - FK's can't be empty
        '
        Dim bRule_4_Met As Boolean = True
        If FK_Child IsNot Nothing AndAlso FK_Parent IsNot Nothing Then
            If FK_Child.Equals(VGuid.Empty("CAT")) OrElse FK_Parent.Equals(VGuid.Empty("CAT")) Then
                sMessage &= vbCrLf
                sMessage &= "XValue can't be empty or Null."
                bRule_4_Met = False
                '
